...
export default {
  ...
  methods:{
     ...
     getUsename(){
       this.code = localStorage.getItem("isLogin");
...
.header .headerImg {
  ...
  height: 68.23px;
  margin-top: 27.174px;
  padding: 0 9.662px 80px 86.051px;
  box-sizing: border-box;
  overflow: hidden;
}
.header .headerImg .imgBorder {
  display: inline-block;
  position: absolute;
  left: 15.097px;
  top: 0;
  border: 3.917px solid rgba(255, 255, 255, 0.5);
  width: 68.229px;
  height: 68.229px;
  border-radius: 50%;
